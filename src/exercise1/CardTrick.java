...
//            Card card = new Card();
//            card.setValue(random.nextInt(13) + 1); // Values from 1 to 13 (inclusive)
...
//        boolean found = false;
//        for (Card card : hand) {
//            if (card.getValue() == userValue && card.getSuit() == userSuit) {
//                found = true;
//                break;
//            }
//        }
...
class Card {
    ...
    // Getter and Setter methods for value and suit
